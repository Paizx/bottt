...
saya Paiz-Md, bot ini adalah Beta Multi-Device Whatsapp. 
...
exports.welcome = () =>{
	return`Selamat datang jangan lupa intro ya
...
exports.leave = () =>{
	return`Yah beban gc out, balik bawain daging wahyu ya mek
Goodbye`
}
exports.source = () =>{
return`*------「 SOURCE CODE 」 ------*
...
Recode 1 : https://youtube.com/playlist?list=PLFCglBzFPHG7vSQaa9S3P8yfla_d9w-2-
Recode 2 : https://github.com/Paizx
`
}
